...
// FUN_000962cc spawn pool: 40×uint32 (indices 0–19 civilian, 20–39 Megapol; 39 is
// the dword the EXE reads at table+0x4C). Caps are 33×uint32 indexed by vehicle id.
#define VEHICLE_PARK_SPAWN_TABLE_OFFSET_START 0x188F18
#define VEHICLE_PARK_SPAWN_TABLE_OFFSET_END 0x188FB8
#define VEHICLE_PARK_SPAWN_CAP_OFFSET_START 0x188FB8
#define VEHICLE_PARK_SPAWN_CAP_OFFSET_END 0x18903C
#define VEHICLE_PARK_SPAWN_POOL_SIZE 20
#define VEHICLE_TYPE_COUNT 33
