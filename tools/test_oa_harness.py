...
# NOTE: the utility()-ordering assertions that lived here moved out with the adversarial arena.
# They exercise scoring, which belongs to the AI layer, not to the driver.
if FAILED:
