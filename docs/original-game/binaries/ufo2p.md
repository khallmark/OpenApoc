...
- Tick rate — original city logic is observational 36 TPS. OpenApoc `TICKS_PER_SECOND = 36 × 4` is intentional; issue 997 is per-mechanic leftover 4×. No literal “36 ticks” string.
