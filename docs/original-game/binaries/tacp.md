...
- Mind Shield — extractor type `0x05`. Bound TACP name strings have empty xrefs. Flat `FUN_0009b780` @ `0x9B780` is the effect candidate (add 30, cap 200). OpenApoc `useItem` still returns false. See [compare-report.html#ghidra](../compare-report.html#ghidra).
