...
5. **Battle cover / potshot modes ([issue 265](https://github.com/OpenApoc/OpenApoc/issues/265))** — specified in [ai.txt](../../tools/extractors/docs/ai.txt); TACP strings name Cautious / Aggressive / kneel. Use `ai.txt` plus TACP decompiler.
